...
void rayGen() {
	...
	RWStructuredBuffer<ReadBackBuffer> readBackBuffer = READBACK_BUFFER_DESCRIPTOR;
	StructuredBuffer<CollisionQuery> collsionQueries = COLLISION_QUERIES_DESCRIPTOR;
	RWStructuredBuffer<CollisionQueryResult> collsionQueryResults = COLLISION_QUERY_RESULTS_DESCRIPTOR;
